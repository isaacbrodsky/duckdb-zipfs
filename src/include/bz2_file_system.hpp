...
class Bz2FileHandle final : public FileHandle {
  friend class Bz2FileSystem;

public:
  Bz2FileHandle(FileSystem &file_system, const string &path,
...
class Bz2FileSystem final : public FileSystem {
public:
  explicit Bz2FileSystem() : FileSystem() {}
  ...
  std::string GetName() const override { return "Bz2FileSystem"; }
